<!-- Sidebar -->
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item  {{ request()->is('sourceOfFunds*') ? 'active' : '' }}{{ request()->is('relationship*') ? 'active' : '' }}{{ request()->is('documentType*') ? 'active' : '' }}{{ request()->is('state*') ? 'active' : '' }}{{ request()->is('city*') ? 'active' : '' }}
