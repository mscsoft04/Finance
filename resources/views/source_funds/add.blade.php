...
<div class="row">
      ...
      <div class="card-body">
      <form method="post" action="{{ route('sourceOfFunds.store') }}" >
        @csrf
		...
		<div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <label for="collectionareaname"><span>Source Of Funds</span></label>
                <input type="text" id="collectionareaname"name="name" value="{{ old('name') }}"  class="form-control" placeholder="Source Of Funds" required>
