        ...
        @csrf
          ...
          <div class="form-group">
            <div class="form-row"> <!-- Form row start-->
              ...
              <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6"> <!-- col-xl-6 start--> 
                
                 <div class="card card-box"> <!-- card start -->
                      ...
                      <div class="col-4 col-sm-4 col-md-3 col-lg-3 col-xl-3">
                        ...
                        <label for="salutationname"><span>Salutation</span></label>
                          <select  id="salutationname" name="salutation_name"  class="form-control selectpicker" >
                             ...
                             <option  value="Mr" {{ old("salutation_name") == "Mr" ? "selected":"" }}>CUDDALORE</option>
                          </select>
                        </div>
