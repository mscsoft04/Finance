                        ...
                        <div class="form-row">
                           ...
                           <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <div class="form-label-group gardian">
                                 ...
                                 <input type="radio" id="rfatherorspouse" name="relation_type" value="spouse" {{ $subscriber->relation_type == 'spouse' ? "checked":"" }}>&nbsp;&nbsp;Others
                              </div>
                              @error('relation_type')
                              <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                           ...
                           <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                              <div class="form-label-group">
                                 ...
                                 <select  id="maritalstatus" name="marital_status"  class="form-control selectpicker" >
                                    ...
                                    <option  value="Single" {{ $subscriber->marital_status == "Single" ? "selected":"" }}>CUDDALORE</option>
                                 </select>
                              </div>
                           ...
                           <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                              <div class="form-label-group">
                                 ...
                                 <select  id="collectionarea" name="collection_area" class="form-control selectpicker" >
                                    ...
                                    <option  value="ACF01" {{ $subscriber->collection_area == "ACF01" ? "selected":"" }}>ACF01</option>
                                 </select>
                              </div>
                           ...
                           <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                              <div class="form-label-group">
                                 ...
                                 <select  id="relationship" name="relationship" class="form-control selectpicker" >
                                    ...
                                    <option  value="FRIEND" {{ $subscriber->relationship == "FRIEND" ? "selected":"" }}>FRIEND</option>
                                 </select>
                              </div>
                              @error('relationship')
                              <span class="invalid-feedback" role="alert">
                           ...
                           <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                              <div class="form-label-group">
                                 ...
                                 <select  id="pstatename" name="p_state" class="form-control selectpicker" >
                                    ...
                                    <option  value="Tamilnadu" {{ $subscriber->p_state == "Tamilnadu" ? "selected":"" }}>Tamilnadu</option>
                                 </select>
                              </div>
                              @error('p_state')
                              <span class="invalid-feedback" role="alert">
                           ...
                           <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                              <div class="form-label-group">
                                 ...
                                 <select  id="pdistrictname" name="p_district" class="form-control selectpicker">
                                    ...
                                    <option  value="Cuddalore" {{ $subscriber->p_district == "Cuddalore" ? "selected":"" }}>Cuddalore</option>
                                 </select>
                              </div>
                              @error('p_district')
                              <span class="invalid-feedback" role="alert">
                           ...
                           <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                              <div class="form-label-group">
                                 ...
                                 <select  id="ptalukname" name="p_taluk" class="form-control selectpicker" >
                                    ...
                                    <option  value="Bhuvanagiri" {{ $subscriber->p_taluk == "Bhuvanagiri" ? "selected":"" }}>Bhuvanagiri</option>
                                 </select>
                              </div>
                              @error('p_taluk')
                              <span class="invalid-feedback" role="alert">
                           ...
                           <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                              <div class="form-label-group">
                                 ...
                                 <select  id="rstatename" name="c_state" class="form-control selectpicker" >
                                    <option value="">State Name</option>
                                    <option  value="Tamilnadu" {{ $subscriber->c_state == "Tamilnadu" ? "selected":"" }}>Tamilnadu</option>
                                 </select>
                              </div>
                              @error('c_state')
                              <span class="invalid-feedback" role="alert">
                           ...
                           <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                              <div class="form-label-group">
                                 ...
                                 <select  id="rdistrictname" name="c_district" class="form-control selectpicker">
                                    <option value="">District</option>
                                    <option  value="Cuddalore" {{ $subscriber->c_district == "Cuddalore" ? "selected":"" }}>Cuddalore</option>
                                 </select>
                              </div>
                              @error('c_district')
                              <span class="invalid-feedback" role="alert">
                           ...
                           <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                              <div class="form-label-group">
                                 ...
                                 <select  id="rtalukname" name="c_taluk" class="form-control selectpicker" >
                                    <option value="">Taluk Name</option>
                                    <option  value="Bhuvanagiri" {{ $subscriber->c_taluk == "Bhuvanagiri" ? "selected":"" }}>Bhuvanagiri</option>
                                 </select>
                              </div>
                              @error('c_taluk')
                              <span class="invalid-feedback" role="alert">
                           ...
                           <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                              <div class="form-label-group">
                                 ...
                                 <select  id="sourceoffund" name="sourceof_fund" class="form-control selectpicker" >
                                    ...
                                    <option  value="GOVERMENT SALARY" {{ $subscriber->sourceof_fund == "GOVERMENT SALARY" ? "selected":"" }}>GOVERMENT SALARY</option>
                                 </select>
                              </div>
                              @error('sourceof_fund')
                              <span class="invalid-feedback" role="alert">
