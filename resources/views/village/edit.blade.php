            ...
            <div class="form-row">
              <div class="col-md-6">
                ...
                <select  id="branchname" name="taluk_id"  class="form-control selectpicker" >
                     ...
                     <option  value="{{$taluk->id}}" {{ $village->taluk_id == $taluk->id ? "selected":"" }}>{{$taluk->name}}</option>
                     @endforeach
                     </select>
		...
		<div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <input type="text" id="collectionareaname"name="name" value="{{ $village->name }}"  class="form-control" placeholder="Village Name" required>
