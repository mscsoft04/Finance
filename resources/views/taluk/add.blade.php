...
<div class="row">
      ...
      <div class="card-body">
      <form method="post" action="{{ route('taluk.store') }}" >
        @csrf
		 ...
		 <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <label for="branchname"><span>City</span></label>
		...
		<div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <input type="text" id="collectionareaname"name="name" value="{{ old('name') }}"  class="form-control" placeholder="Taluk Name" required>
