                	...
                	<div class="widget-bg"> 
                      ...
                      <div class="card-header">
                      	<div class="inner-header">
                            ...
                            <a class="btn btn-link btn-sm btn-global btn-blue btn-fl-r"  href="{{ route('agent.create') }}">
     ...
     $(document).on("click",".show",function(e) {
      e.preventDefault();
       var id=$(this).attr("data-id");
        var show_url="{{ route('agent.show', ['agent' =>":id"]) }}";
