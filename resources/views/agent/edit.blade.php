   ...
   <div class="breadcrumbbar">
      <ul>
         <li class="breadcrumb-item">
            <a href="{{ url('agent') }}"><span>Agent</span><i class="fas fa-arrow-left fa-fw"></i></a>
         </li>
...
<div class="row">
   <div class="col-lg-12">
      <div class="widget-bg">
         <div class="card  ">
            <div class="card-body">
               <form method="post" action="{{ route('agent.update',["agent"=>$agent->id]) }}" >
                  @csrf
                  @method('PATCH')
                                         ...
                                         <div class="col-4 col-sm-4 col-md-3 col-lg-3 col-xl-3">
                                             <div class="form-label-group">
                                                 ...
                                                 <select name="salutation_name" class="form-control">
                                                   <option  value="Mr" {{ $agent->salutation_name == "Mr" ? "selected":"" }}>Mr</option>
                                                   <option  value="Mrs" {{ $agent->salutation_name == "Mrs" ? "selected":"" }}>Mrs</option>
                                                   <option  value="Dr" {{ $agent->salutation_name == "Dr" ? "selected":"" }}>Dr</option>
                                                   <option  value="Prof" {{ $agent->salutation_name == "Prof" ? "selected":"" }}>Prof</option>
                                                   <option  value="Rev" {{ $agent->salutation_name == "Rev" ? "selected":"" }}>Rev</option>
                                                   <option  value="Other" {{ $agent->salutation_name == "Other" ? "selected":"" }}>Other</option>
                                                 </select>
                                             </div>
                                       ...
                                       @enderror
                                         ...
                                         <div class="col-4 col-sm-4 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="agent_name"  class="form-control" value="{{ $agent->agent_name }}" placeholder="Agent Name">
                                             </div>
                                             @error('agent_name')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                         ...
                                         <div class="col-4 col-sm-4 col-md-3 col-lg-3 col-xl-3">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="Initial_name" value="{{ $agent->Initial_name }}" class="form-control" placeholder="Initial">
                                             </div>
                                             @error('Initial_name')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                     ...
                                     <div class="form-row">
                                         ...
                                         <div class="col-3 col-sm-3 col-md-4 col-lg-2 col-xl-2">
                                             <div class="form-label-group">
                                                 ...
                                                 <select class="form-control" name="relation_type">
                                                   <option value="S/o" {{ $agent->relation_type == "S/o" ? "selected":"" }}>S/o</option>
                                                   <option value="W/o" {{ $agent->relation_type == "W/o" ? "selected":"" }}>W/o</option>
                                                   <option value="D/o" {{ $agent->relation_type == "D/o" ? "selected":"" }}>D/o</option>
                                                   <option value="R/o" {{ $agent->relation_type == "R/o" ? "selected":"" }}>R/o</option>
                                         ...
                                         <div class="col-3 col-sm-3 col-md-8 col-lg-10 col-xl-10">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="name_of_father" value="{{ $agent->name_of_father }}" class="form-control" placeholder="Father/SpouseName">
                                             </div>
                                     ...
                                     <div class="form-row">
                                         ...
                                         <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text" name="dob" value="{{ $agent->dob }}" class="form-control nominee-dob date">
                                             </div>
                                             @error('dob')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  class="form-control nominee-age" value="{{ $agent->age }}" name="age" placeholder="Age">
                                             </div>
                                             @error('age')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-7 col-lg-7 col-xl-7">
                                             <div class="form-label-group gendertab">
                                                 <input type="radio" id="Male"  name="gender" value="male" {{ $agent->gender == "male" ? "checked":"checked" }}>&nbsp;&nbsp;Male&nbsp;&nbsp;                        
                                                 <input type="radio" id="Female" name="gender" value="female" {{ $agent->gender == "female" ? "checked":"" }}>&nbsp;&nbsp;Female&nbsp;&nbsp; 
                                                 <input type="radio" id="Transgender" name="gender"  value="transgender" {{ $agent->gender == "transgender" ? "checked":"" }}>&nbsp;&nbsp;Transgender
                                     ...
                                     <div class="form-row">
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <select id="maritalstatus" name="marital_status" class="form-control selectpicker">
                                                   <option  value="Single" {{ $agent->marital_status == "Single" ? "selected":"" }}>Single</option>
                                                   <option  value="Married" {{ $agent->marital_status == "Married" ? "selected":"" }}>Married</option>
                                                   <option  value="Widowed" {{ $agent->marital_status == "Widowed" ? "selected":"" }}>Widowed</option>
                                                   <option  value="Divorced" {{ $agent->marital_status == "Divorced" ? "selected":"" }}>Divorced</option>
                                                 </select>
                                             </div>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  class="form-control date" name="doj" value="{{ $agent->doj }}">
                                             </div>
                                             @error('doj')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                     ...
                                     <div class="form-row">
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  class="form-control" name="occupation" value="{{ $agent->occupation }}" placeholder="Occupation">
                                             </div>
                                             @error('occupation')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text" name="qualification"  value="{{ $agent->qualification }}" class="form-control" placeholder="Qualification">
                                             </div>
                                             @error('qualification')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                      ...
                                      <div class="form-row">
                                       <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                          <div class="form-label-group">
                                             ...
                                             <input type="text" name="designation"  value="{{ $agent->designation }}" class="form-control" placeholder="Designation / Department">
                                         </div>
                                         @error('designation')
                                         <span class="invalid-feedback" role="alert">
                                         <strong>{{ $message }}</strong>
                                       ...
                                       <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                           <div class="form-label-group">
                                            ...
                                            <option value="{{ $doc->id }}" {{ $agent->document_id == $doc->id ? "selected":"" }}>{{ $doc->name }}</option>
                                                @endforeach
                                            </select>   </div>
                                           @error('document_id')
                                           <span class="invalid-feedback" role="alert">
                                       ...
                                       <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                           <div class="form-label-group">
                                               ...
                                               <input type="text" name="document_number"  value="{{ $agent->document_number }}" class="form-control" placeholder="Document Number">
                                           </div>
                                     ...
                                     <div class="form-row">
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <select  name="state" class="form-control nominee_state">
                                                  ...
                                                  <option  value="{{$state->id}}" {{ $agent->state == $state->id ? "selected":"" }}>{{ $state->name }}</option>
                                                  @endforeach
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <select name="district" class="form-control nominee_district">
                                                  ...
                                                  <option  value="{{$city->id}}" {{ $agent->district == $city->id ? "selected":"" }}>{{ $city->name }}</option>
                                                  @endforeach
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <select id="ptalukname" name="taluk" class="form-control nominee_taluk">
                                                  ...
                                                  <option  value="{{$taluk->id}}" {{ $agent->taluk == $taluk->id ? "selected":"" }}>{{ $taluk->name }}</option>
                                                  @endforeach
                                                 </select>
                                             </div>
                                             @error('taluk')
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                          ...
                                          <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <textarea  class="form-control" name="address" rows="2" >{{ $agent->address }}</textarea>
                                             </div>
                                             @error('address')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  class="form-control" name="pincode" value="{{ $agent->pincode }}" placeholder="Pin code">
                                             </div>
                                             @error('pincode')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="mobile_no" value="{{ $agent->mobile_no }}" class="form-control" placeholder="Mobile No">
                                             </div>
                                             @error('mobile_no')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="phone_no" value="{{ $agent->phone_no }}" class="form-control" placeholder="Phone No">
                                             </div>
                                             @error('phone_no')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="mail_id" class="form-control" value="{{ $agent->mail_id }}" placeholder="Mail ID">
                                             </div>
                                             @error('mail_id')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                           <div class="form-row">
                               ...
                               <div class="col-12 col-sm-12 col-md-5 col-lg-4 col-xl-4 uploadbtn">
                                   <input type="hidden"  class="form-control profile" name="image" value="{{ $agent->image }}">
