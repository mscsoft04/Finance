		 ...
		 <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <label for="collectionareaname"><span>State Name</span></label>
                <select  id="branchname" name="state_id"  class="form-control selectpicker" >
				             <option value="">Select State</option>
                     @foreach ($state as $st)
                     <option  value="{{$st->id}}" {{ $city->state_id == $st->id ? "selected":"" }}>{{$st->name}}</option>
                     @endforeach
                     </select>
		...
		<div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <input type="text" id="collectionareaname"name="name" value="{{ $city->name }}"  class="form-control" placeholder="City Name" required>
