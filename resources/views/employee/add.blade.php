                                       ...
                                       @enderror
                                         ...
                                         <div class="col-4 col-sm-4 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="employee_name"  class="form-control" value="{{ old('employee_name') }}" placeholder="Employee Name">
                                             </div>
                                             @error('employee_name')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                         ...
                                         <div class="col-4 col-sm-4 col-md-3 col-lg-3 col-xl-3">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="Initial_name" value="{{ old('Initial_name') }}" class="form-control" placeholder="Initial">
                                             </div>
                                             @error('Initial_name')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                     ...
                                     <div class="form-row">
                                         ...
                                         <div class="col-3 col-sm-3 col-md-4 col-lg-2 col-xl-2">
                                             <div class="form-label-group">
                                                 ...
                                                 <select class="form-control" name="relation_type">
                                                   ...
                                                   <option value="R/o" {{ old("relation_type") == "R/o" ? "selected":"" }}>R/o</option>
                                         ...
                                         <div class="col-3 col-sm-3 col-md-8 col-lg-10 col-xl-10">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="name_of_father" value="{{ old('name_of_father') }}" class="form-control" placeholder="Father/SpouseName">
                                             </div>
                                     ...
                                     <div class="form-row">
                                         ...
                                         <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text" name="dob" value="{{ old('dob') }}" class="form-control nominee-dob date">
                                             </div>
                                             @error('dob')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  class="form-control nominee-age" value="{{ old('age') }}" name="age" placeholder="Age">
                                             </div>
                                             @error('age')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                     ...
                                     <div class="form-row">                                
                                         <!--Form row start -->
                                          ...
                                          <div class="form-label-group">
                                             ...
                                             <input type="text" name="employee_code"  value="{{ old('employee_code') }}" class="form-control" placeholder="Employee Code">
                                         </div>
                                         @error('employee_code')
                                         <span class="invalid-feedback" role="alert">
                                         <strong>{{ $message }}</strong>
                                        ...
                                        <div class="form-row">                                
                                         ...
                                         <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                          <div class="form-label-group">
                                             ...
                                             <input type="text" name="designation"  value="{{ old('designation') }}" class="form-control" placeholder="Designation / Department">
                                         </div>
                                         @error('designation')
                                         <span class="invalid-feedback" role="alert">
                                         <strong>{{ $message }}</strong>
                                        ...
                                        @enderror
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  class="form-control date" name="doj" value="{{ old('doj') }}">
                                             </div>
                                             @error('doj')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                      ...
                                      <div class="form-row">                                   
                                       ...
                                       <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                           <div class="form-label-group">
                                            ...
                                            <option value="{{ $doc->id }}" {{ old("document_id") == $doc->id ? "selected":"" }}>{{ $doc->name }}</option>
                                                @endforeach
                                            </select>   </div>
                                           @error('document_id')
                                           <span class="invalid-feedback" role="alert">
                                       ...
                                       <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                           <div class="form-label-group">
                                               ...
                                               <input type="text" name="document_number"  value="{{ old('document_number') }}" class="form-control" placeholder="Document Number">
                                           </div>
                                     ...
                                     <div class="form-row">
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <select name="district" class="form-control nominee_district">
                                                  ...
                                                  <option  value="{{$city->id}}" {{ old("district") == $city->id ? "selected":"" }}>{{ $city->name }}</option>
                                                  @endforeach
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                          ...
                                          <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <textarea  class="form-control" name="address" rows="2" value="{{ old('address') }}"></textarea>
                                             </div>
                                             @error('address')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  class="form-control" name="pincode" value="{{ old('pincode') }}" placeholder="Pin code">
                                             </div>
                                             @error('pincode')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="mobile_no" value="{{ old('mobile_no') }}" class="form-control" placeholder="Mobile No">
                                             </div>
                                             @error('mobile_no')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="mail_id" class="form-control" value="{{ old('mail_id') }}" placeholder="Mail ID">
                                             </div>
                                             @error('mail_id')
                                             <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                           <div class="form-row">
                               ...
                               <div class="col-12 col-sm-12 col-md-5 col-lg-4 col-xl-4 uploadbtn">
                                   <input type="hidden"  class="form-control profile" name="image" value="{{ old('image') }}">
