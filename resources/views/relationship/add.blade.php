		...
		<div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <label for="collectionareaname"><span>Relationship</span></label>
                <input type="text" id="collectionareaname"name="name" value="{{ old('name') }}"  class="form-control" placeholder="Relationship" required>
