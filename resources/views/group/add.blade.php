                             ...
                             <div class="form-row">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                  <div class="form-label-group">
                                    ...
                                    <select  id="schemes" name="schemes_id"  class="form-control selectpicker" >
                                         ...
                                         <option  value="{{$scheme->id}}" {{ old("schemes_id") == $scheme->id ? "selected":"" }}>{{$scheme->sort_form}}</option>
                                         @endforeach
                                         </select>
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                  <div class="form-label-group">
                                    ...
                                    <input type="text" id="auction_day" name="auction_day" value="{{ old('auction_day') }}" class="form-control" placeholder="Auction Day" >
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                  ...
                                  <div class="form-label-group">
                                    ...
                                    <input type="text" id="auction_time" class="form-control" name="auction_time"  value="{{ old('auction_time') }}" placeholder="Auction Time" >
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                  ...
                                  <div class="form-label-group">
                                    ...
                                    <input type="text" id="first_auction_date" name="first_auction_date" value="{{ old('first_auction_date') }}" class="form-control date" placeholder="First Auction Date" >
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                   ...
                                   <div class="form-label-group">
                                      ...
                                      <input type="text" id="second-auction-date" name="second_auction_date" value="{{ old('second_auction_date') }}" class="form-control date" placeholder="Second Auction Date">
                                   </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                   ...
                                   <div class="form-label-group">
                                      ...
                                      <input type="text" id="last-auction-date" name="last_auction_date" value="{{ old('last_auction_date') }}" class="form-control date" placeholder="Last Auction Date">
                                   </div>
                             ...
                             <div class="form-row">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                  <div class="form-label-group">
                                    ...
                                    <input type="text" id="pso_number" class="form-control" name="pso_number"  value="{{ old('pso_number') }}" placeholder="PSO Number" >
                                  ...
                                  <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-label-group">
                                      ...
                                      <input type="text" id="pso_date" class="form-control date" name="pso_date" value="{{ old('pso_date') }}" placeholder="PSO Date" >
                                  ...
                                  <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-label-group">
                                      ...
                                      <input type="text" id="blaw_number" class="form-control" name="blaw_number"  value="{{ old('blaw_number') }}" placeholder="Blaw Number" >
                                   ...
                                   <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-label-group">
                                      ...
                                      <input type="text" id="blaw_date" class="form-control date" name="blaw_date" value="{{ old('blaw_date') }}" placeholder="Blaw Date" >
                                   ...
                                   <div class="form-label-group">
                                      ...
                                      <input type="text" class="form-control" name ="blaw_amount" value="{{ old('blaw_amount') }}" id ="by-law-amount" placeholder="By Law Amount">
                                   </div>
                                   @error('blaw_amount')
                                       <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                             ...
                             <div class="form-row">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                  <div class="form-label-group">
                                    ...
                                    <input type="text" id="fd_branch" class="form-control" name="fd_branch" value="{{ old('fd_branch') }}"  placeholder="FD Branch" >
                                  ...
                                  <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-label-group">
                                      ...
                                      <input type="text" id="fd_number" class="form-control" name="fd_number" value="{{ old('fd_number') }}"  placeholder="FD Number" >
                                  ...
                                  <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                   ...
                                   <div class="form-label-group">
                                      ...
                                      <input type="text" class="form-control" name ="fd_amount"  value="{{ old('fd_amount') }}" id ="FD Amount" placeholder="FD Amount">
                                   </div>
                                   @error('fd_amount')
                                   <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                  ...
                                  <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-label-group">
                                      ...
                                      <input type="text" class="form-control" name ="commission" value="{{ old('commission') }}" id ="Commision" placeholder="Commision">
                                    </div>
                                    @error('commission')
                                    <span class="invalid-feedback" role="alert">
                                         <strong>{{ $message }}</strong>
                                   ...
                                   <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-label-group">
                                      ...
                                      <input type="text" class="form-control" name ="fd_maturity_interest" value="{{ old('fd_maturity_interest') }}" id ="fd-maturity-interest" placeholder="FD Maturity Interest">
                                    </div>
                                   ...
                                   <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-label-group">
                                      ...
                                      <input type="text" class="form-control date" name ="fd_maturity_date" value="{{ old('fd_maturity_date') }}" id ="fd-maturity-date" placeholder="FD Maturity Date">
                                    </div>
                                   ...
                                   <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-label-group">
                                      ...
                                      <input type="text" id="fd_bank" class="form-control" name="fd_bank" value="{{ old('fd_bank') }}"  placeholder="FD Bank" >
                                   ...
                                   <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-label-group">
                                      ...
                                      <input type="text" id="cheque_no" class="form-control" name="cheque_no"  value="{{ old('cheque_no') }}" placeholder="Cheque No" >
                                ...
                                <div class="form-row">
                                  ...
                                  <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-label-group">
                                      ...
                                      <input type="text" id="company_chit" class="form-control" name="company_chit"  value="{{ old('company_chit') }}" placeholder="Company Chit" >
                                  ...
                                  <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-label-group gardian">
                                      <input type="radio" id="agentType" name="group_Type" {{ old("group_Type") == 'register' ? "checked":"checked" }} value="register">&nbsp;&nbsp;Register &nbsp;&nbsp;&nbsp;
                                      <input type="radio" id="agentType1" name="group_Type" {{ old("group_Type") == 'un-register' ? "checked":"" }} value="un-register">&nbsp;&nbsp;Un Register&nbsp;&nbsp;&nbsp;
                                   </div>
                                   <br/>
                                  </div>
                                </div>
