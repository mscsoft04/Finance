...
class NomineeDetailsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        'nominee_name'=>'required|alpha|max:20',
    ...
    $array = array('subscriber_id'=>$request['subscriber_id'], 
          ...
          $nomineeDetails=NomineeDetails::create($array);
    if($request->hasfile('file')){
        ...
        for ($x = 0; $x <= $count-1; $x++) {
            ...
            $data[]=array('nominee_id'=>$nomineeDetails->id, 
     ...
     *
     * @param  \App\NomineeDetails  $nomineeDetails
     * @return \Illuminate\Http\Response
     */
    public function show(NomineeDetails $nomineeDetails)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(NomineeDetails $nomineeDetails)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, NomineeDetails $nomineeDetails)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(NomineeDetails $nomineeDetails)
    {
        //
    }
}
