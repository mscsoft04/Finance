...
class SubscriberController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request,   ['branch_id'=>'required|exists:branches,id', 
                                    ...
                                    'aadhar_no'=>'required_without_all:pan_no,rationcard_no,driving_licence,voter_id|nullable|unique:subscribers,aadhar_no|max:12',
                                    'pan_no'=>'required_without_all:aadhar_no,rationcard_no,driving_licence,voter_id|nullable|unique:subscribers,pan_no|max:12',
                                    'rationcard_no'=>'required_without_all:aadhar_no,pan_no,driving_licence,voter_id|nullable|unique:subscribers,rationcard_no|max:20',
                                    'driving_licence'=>'required_without_all:aadhar_no,pan_no,rationcard_no,voter_id|nullable|unique:subscribers,driving_licence|max:20',
                                    'voter_id'=>'required_without_all:aadhar_no,pan_no,rationcard_no,driving_licence|nullable|unique:subscribers,voter_id|max:20',
    ...
    public function update(Request $request, Subscriber $subscriber)
    {
        ...
        $this->validate($request,   ['branch_id'=>'required|exists:branches,id', 
                                    ...
                                    'phone_no'=>'nullable|numeric|digits_between:8,12',
                                    'aadhar_no'=>'required_without_all:pan_no,rationcard_no,driving_licence,voter_id|nullable|max:12|unique:subscribers,aadhar_no,'.$subscriber->id,
                                    'pan_no'=>'required_without_all:aadhar_no,rationcard_no,driving_licence,voter_id|nullable|max:12|unique:subscribers,pan_no,'.$subscriber->id,
                                    'rationcard_no'=>'required_without_all:aadhar_no,pan_no,driving_licence,voter_id|nullable|max:20|unique:subscribers,rationcard_no,'.$subscriber->id,
                                    'driving_licence'=>'required_without_all:aadhar_no,pan_no,rationcard_no,voter_id|nullable|max:20|unique:subscribers,driving_licence,'.$subscriber->id,
                                    'voter_id'=>'required_without_all:aadhar_no,pan_no,rationcard_no,driving_licence|nullable|max:20|unique:subscribers,voter_id,'.$subscriber->id,
                                    'gst_no'=>'nullable|max:20',
                                    'p_address'=>'required|max:400',
                                    'p_state'=>'required|exists:states,id',
                                    'p_district'=>'required|exists:cities,id',
