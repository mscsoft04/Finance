<?php $__env->startSection('title', 'collection-area'); ?>
...
<div class="col-lg-9 col-md-8 col-sm-8 col-2">
            	...
            	<div class="breadcrumbbar">
                	<ul>
                        ...
                        <a href="<?php echo e(url('collection-area')); ?>"><span>Collection-area</span><i class="fas fa-arrow-left fa-fw"></i></a>
                        </li>
...
<?php $__env->startSection('content'); ?>
          ...
          <div class="card-header">
          	<div class="inner-header">
                ...
                <a class="btn btn-link btn-sm btn-global btn-blue btn-fl-r"  href="<?php echo e(route('collection-area.create')); ?>">
...
$(document).ready(function() {
  ...
  var editIcon = function ( data, type, full, meta ) {
   ...
   var table=  $('.subscriber').DataTable({
        ...
        "ajax": "<?php echo e(route('collection.getdata')); ?>",
        ...
        "columns":[
            ...
            {  "data": "id", render: function ( data, type, row ) {
                if ( type === 'display' ) {
                  var url = '<?php echo e(route("collection-area.edit", [":id"])); ?>';
     ...
     $(document).on("click",".show",function(e) {
      e.preventDefault();
       var id=$(this).attr("data-id");
        var show_url="<?php echo e(route('collection-area.show', ['collectionArea' =>":id"])); ?>";
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\finance\finance\resources\views/collection-areas/index.blade.php ENDPATH**/ ?>