    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-12 col-lg-4 col-md-4 bottomgap">
            <a href="/snippets/" class="after-loop-item card border-0 card-snippets">
                <div class="card-body d-flex align-items-end flex-column text-right">
                <h4>Branch</h4>
                <h2 class="w-75"><?php echo e($branch); ?></h2>
        ...
        <div class="col-12 col-sm-12 col-lg-4 col-md-4 bottomgap">
            ...
            <div class="card-body d-flex align-items-end flex-column text-right">
                <h4>Subscriber</h4>
                <h2 class="w-75"><?php echo e($subscriber); ?></h2>
        ...
        <div class="col-12 col-sm-12 col-lg-4 col-md-4 bottomgap">
            <a href="/snippets/" class="after-loop-item card border-0 card-pending">
                ...
                <h2 class="w-75"><?php echo e($thisMonth_credit); ?></h2>
                <i class="fas fa-file-invoice-dollar"></i>
                </div>
            </a>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\finance\finance\resources\views/home.blade.php ENDPATH**/ ?>