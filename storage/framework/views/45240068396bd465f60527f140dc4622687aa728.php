                	...
                	<div class="widget-bg"> 
                      ...
                      <div class="card-header">
                      	<div class="inner-header">
                            ...
                            <a class="btn btn-link btn-sm btn-global btn-blue btn-fl-r"  href="<?php echo e(route('subscriber.create')); ?>">
...
$(document).ready(function() {
  ...
  var table= $('.subscriber').DataTable({
        ...
        "ajax": "<?php echo e(route('subscriber.getdata')); ?>",
        ...
        "columns":[
          { "data": "unique_id" },
            ...
            { "data": "id",render: function ( data, type, row ) {
                if ( type === 'display' ) {
                  var url = '<?php echo e(route("subscriber.edit", [":id"])); ?>';
     ...
     $(document).on("click",".show",function(e) {
      e.preventDefault();
       var id=$(this).attr("data-id");
        var show_url="<?php echo e(route('subscriber.show', ['subscriber' =>":id"])); ?>";
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\New folder\resources\views/subscriber/index.blade.php ENDPATH**/ ?>