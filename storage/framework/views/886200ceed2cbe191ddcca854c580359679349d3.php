...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-4 col-sm-4 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="employee_name"  class="form-control" value="<?php echo e(old('employee_name')); ?>" placeholder="Employee Name">
                                             </div>
                                     ...
                                     <div class="form-row">                                
                                         <!--Form row start -->
                                          ...
                                          <div class="form-label-group">
                                             ...
                                             <input type="text" name="employee_code"  value="<?php echo e(old('employee_code')); ?>" class="form-control" placeholder="Employee Code">
                                         </div>
                                   ...
                                   <!--Form row end -->
                                         ...
                                         <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                          <div class="form-label-group">
                                             ...
                                             <input type="text" name="salary"  value="<?php echo e(old('salary')); ?>" class="form-control" placeholder="Salary">
                                         </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\finance\finance\resources\views/employee/add.blade.php ENDPATH**/ ?>