   ...
   <div class="breadcrumbbar">
      <ul>
         <li class="breadcrumb-item">
            <a href="<?php echo e(url('employee')); ?>"><span>Employee</span><i class="fas fa-arrow-left fa-fw"></i></a>
         </li>
...
<div class="row">
   <div class="col-lg-12">
      <div class="widget-bg">
         <div class="card  ">
            <div class="card-body">
                <form method="post" action="<?php echo e(route('employee.update',["employee"=>$employee->id])); ?>" >
                    <?php echo csrf_field(); ?>
                                         ...
                                         <div class="col-4 col-sm-4 col-md-3 col-lg-3 col-xl-3">
                                             <div class="form-label-group">
                                                 ...
                                                 <select name="salutation_name" class="form-control">
                                                   <option  value="Mr" <?php echo e($employee->salutation_name == "Mr" ? "selected":""); ?>>Mr</option>
                                                   <option  value="Mrs" <?php echo e($employee->salutation_name == "Mrs" ? "selected":""); ?>>Mrs</option>
                                                   <option  value="Dr" <?php echo e($employee->salutation_name == "Dr" ? "selected":""); ?>>Dr</option>
                                                   <option  value="Prof" <?php echo e($employee->salutation_name == "Prof" ? "selected":""); ?>>Prof</option>
                                                   <option  value="Rev" <?php echo e($employee->salutation_name == "Rev" ? "selected":""); ?>>Rev</option>
                                                   <option  value="Other" <?php echo e($employee->salutation_name == "Other" ? "selected":""); ?>>Other</option>
                                                 </select>
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-4 col-sm-4 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="employee_name"  class="form-control" value="<?php echo e($employee->employee_name); ?>" placeholder="Employee Name">
                                             </div>
                                             <?php if ($errors->has('employee_name')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('employee_name'); ?>
                                             <span class="invalid-feedback" role="alert">
                                             <strong><?php echo e($message); ?></strong>
                                             </span>
                                             <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-4 col-sm-4 col-md-3 col-lg-3 col-xl-3">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="Initial_name" value="<?php echo e($employee->Initial_name); ?>" class="form-control" placeholder="Initial">
                                             </div>
                                         ...
                                         <div class="col-3 col-sm-3 col-md-4 col-lg-2 col-xl-2">
                                             <div class="form-label-group">
                                                 ...
                                                 <select class="form-control" name="relation_type">
                                                   <option value="S/o" <?php echo e($employee->relation_type == "S/o" ? "selected":""); ?>>S/o</option>
                                                   <option value="W/o" <?php echo e($employee->relation_type == "W/o" ? "selected":""); ?>>W/o</option>
                                                   <option value="D/o" <?php echo e($employee->relation_type == "D/o" ? "selected":""); ?>>D/o</option>
                                                   <option value="R/o" <?php echo e($employee->relation_type == "R/o" ? "selected":""); ?>>R/o</option>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-3 col-sm-3 col-md-8 col-lg-10 col-xl-10">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="name_of_father" value="<?php echo e($employee->name_of_father); ?>" class="form-control" placeholder="Father/SpouseName">
                                             </div>
                                     ...
                                     <div class="form-row">
                                         ...
                                         <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text" name="dob" value="<?php echo e($employee->dob); ?>" class="form-control nominee-dob date">
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  class="form-control nominee-age" value="<?php echo e($employee->age); ?>" name="age" placeholder="Age">
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-12 col-sm-12 col-md-7 col-lg-7 col-xl-7">
                                             <div class="form-label-group gendertab">
                                                 <input type="radio" id="Male"  name="gender" value="male" <?php echo e($employee->gender == "male" ? "checked":"checked"); ?>>&nbsp;&nbsp;Male&nbsp;&nbsp;                        
                                                 <input type="radio" id="Female" name="gender" value="female" <?php echo e($employee->gender == "female" ? "checked":""); ?>>&nbsp;&nbsp;Female&nbsp;&nbsp; 
                                                 <input type="radio" id="Transgender" name="gender"  value="transgender" <?php echo e($employee->gender == "transgender" ? "checked":""); ?>>&nbsp;&nbsp;Transgender
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text" name="qualification"  value="<?php echo e($employee->qualification); ?>" class="form-control" placeholder="Qualification">
                                             </div>
                                     ...
                                     <div class="form-row">                                
                                         <!--Form row start -->
                                          ...
                                          <div class="form-label-group">
                                             ...
                                             <input type="text" name="employee_code"  value="<?php echo e($employee->employee_code); ?>"  class="form-control" placeholder="Employee Code">
                                         </div>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                  <option  value="<?php echo e($role->id); ?>" <?php echo e($employee->role == $role->id ? "selected":""); ?>><?php echo e($role->name); ?></option>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                 </select>
                                             </div>
                                        ...
                                        <div class="form-row">                                
                                         ...
                                         <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                          <div class="form-label-group">
                                             ...
                                             <input type="text" name="designation"  value="<?php echo e($employee->designation); ?>" class="form-control" placeholder="Designation / Department">
                                         </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  class="form-control date" name="doj" value="<?php echo e($employee->doj); ?>">
                                             </div>
                                      ...
                                      <div class="form-row">                                   
                                       ...
                                       <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                           <div class="form-label-group">
                                            ...
                                            <option value="<?php echo e($doc->id); ?>" <?php echo e($employee->document_id == $doc->id ? "selected":""); ?>><?php echo e($doc->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>   </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                       ...
                                       <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                           <div class="form-label-group">
                                               ...
                                               <input type="text" name="document_number"  value="<?php echo e($employee->document_number); ?>" class="form-control" placeholder="Document Number">
                                           </div>
                                   ...
                                   <!--Form row end -->
                                         ...
                                         <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                          <div class="form-label-group">
                                             ...
                                             <input type="text" name="salary"  value="<?php echo e($employee->salary); ?>" class="form-control" placeholder="Salary">
                                         </div>
                                         <?php if ($errors->has('empcode')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('empcode'); ?>
                                         <span class="invalid-feedback" role="alert">
                                         <strong><?php echo e($message); ?></strong>
                                         </span>
                                        <?php unset($message);
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <select  name="state" class="form-control nominee_state">
                                                  ...
                                                  <option  value="<?php echo e($state->id); ?>" <?php echo e($employee->state == $state->id ? "selected":""); ?>><?php echo e($state->name); ?></option>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <select name="district" class="form-control nominee_district">
                                                  ...
                                                  <option  value="<?php echo e($city->id); ?>" <?php echo e($employee->district == $city->id ? "selected":""); ?>><?php echo e($city->name); ?></option>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <select id="ptalukname" name="taluk" class="form-control nominee_taluk">
                                                  ...
                                                  <option  value="<?php echo e($taluk->id); ?>" <?php echo e($employee->taluk == $taluk->id ? "selected":""); ?>><?php echo e($taluk->name); ?></option>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                 </select>
                                             </div>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <select  name="village" class="form-control nominee_village">
                                                  ...
                                                  <option  value="<?php echo e($village->id); ?>" <?php echo e($employee->village == $village->id ? "selected":""); ?> ><?php echo e($village->name); ?></option>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                 </select>
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                          ...
                                          <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <textarea  class="form-control" name="address" rows="2" value="<?php echo e($employee->address); ?>"></textarea>
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  class="form-control" name="pincode" value="<?php echo e($employee->pincode); ?>" placeholder="Pin code">
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="mobile_no" value="<?php echo e($employee->mobile_no); ?>" class="form-control" placeholder="Mobile No">
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="phone_no" value="<?php echo e($employee->phone_no); ?>" class="form-control" placeholder="Phone No">
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="mail_id" class="form-control" value="<?php echo e($employee->mail_id); ?>" placeholder="Mail ID">
                                             </div>
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                           <div class="form-row">
                               ...
                               <div class="col-12 col-sm-12 col-md-5 col-lg-4 col-xl-4 uploadbtn">
                                   <input type="hidden"  class="form-control profile" name="image" value="<?php echo e($employee->image); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\finance\finance\resources\views/employee/edit.blade.php ENDPATH**/ ?>