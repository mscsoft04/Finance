...
<div class="row">
   <div class="col-lg-12">
      <div class="widget-bg">
         <div class="card  ">
            <div class="card-body">
               <form method="post" action="<?php echo e(route('agent.update',["agent"=>$agent->id])); ?>" >
                  <?php echo csrf_field(); ?>
                                         ...
                                         <div class="col-4 col-sm-4 col-md-3 col-lg-3 col-xl-3">
                                             <div class="form-label-group">
                                                 ...
                                                 <select name="salutation_name" class="form-control">
                                                   <option  value="Mr" <?php echo e($agent->salutation_name == "Mr" ? "selected":""); ?>>Mr</option>
                                                   <option  value="Mrs" <?php echo e($agent->salutation_name == "Mrs" ? "selected":""); ?>>Mrs</option>
                                                   <option  value="Dr" <?php echo e($agent->salutation_name == "Dr" ? "selected":""); ?>>Dr</option>
                                                   <option  value="Prof" <?php echo e($agent->salutation_name == "Prof" ? "selected":""); ?>>Prof</option>
                                                   <option  value="Rev" <?php echo e($agent->salutation_name == "Rev" ? "selected":""); ?>>Rev</option>
                                                   <option  value="Other" <?php echo e($agent->salutation_name == "Other" ? "selected":""); ?>>Other</option>
                                                 </select>
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-4 col-sm-4 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="agent_name"  class="form-control" value="<?php echo e($agent->agent_name); ?>" placeholder="Agent Name">
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-4 col-sm-4 col-md-3 col-lg-3 col-xl-3">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="Initial_name" value="<?php echo e($agent->Initial_name); ?>" class="form-control" placeholder="Initial">
                                             </div>
                                         ...
                                         <div class="col-3 col-sm-3 col-md-4 col-lg-2 col-xl-2">
                                             <div class="form-label-group">
                                                 ...
                                                 <select class="form-control" name="relation_type">
                                                   <option value="S/o" <?php echo e($agent->relation_type == "S/o" ? "selected":""); ?>>S/o</option>
                                                   <option value="W/o" <?php echo e($agent->relation_type == "W/o" ? "selected":""); ?>>W/o</option>
                                                   <option value="D/o" <?php echo e($agent->relation_type == "D/o" ? "selected":""); ?>>D/o</option>
                                                   <option value="R/o" <?php echo e($agent->relation_type == "R/o" ? "selected":""); ?>>R/o</option>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-3 col-sm-3 col-md-8 col-lg-10 col-xl-10">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="name_of_father" value="<?php echo e($agent->name_of_father); ?>" class="form-control" placeholder="Father/SpouseName">
                                             </div>
                                     ...
                                     <div class="form-row">
                                         ...
                                         <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text" name="dob" value="<?php echo e($agent->dob); ?>" class="form-control nominee-dob date">
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  class="form-control nominee-age" value="<?php echo e($agent->age); ?>" name="age" placeholder="Age">
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-12 col-sm-12 col-md-7 col-lg-7 col-xl-7">
                                             <div class="form-label-group gendertab">
                                                 <input type="radio" id="Male"  name="gender" value="male" <?php echo e($agent->gender == "male" ? "checked":"checked"); ?>>&nbsp;&nbsp;Male&nbsp;&nbsp;                        
                                                 <input type="radio" id="Female" name="gender" value="female" <?php echo e($agent->gender == "female" ? "checked":""); ?>>&nbsp;&nbsp;Female&nbsp;&nbsp; 
                                                 <input type="radio" id="Transgender" name="gender"  value="transgender" <?php echo e($agent->gender == "transgender" ? "checked":""); ?>>&nbsp;&nbsp;Transgender
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <select id="maritalstatus" name="marital_status" class="form-control selectpicker">
                                                   <option  value="Single" <?php echo e($agent->marital_status == "Single" ? "selected":""); ?>>Single</option>
                                                   <option  value="Married" <?php echo e($agent->marital_status == "Married" ? "selected":""); ?>>Married</option>
                                                   <option  value="Widowed" <?php echo e($agent->marital_status == "Widowed" ? "selected":""); ?>>Widowed</option>
                                                   <option  value="Divorced" <?php echo e($agent->marital_status == "Divorced" ? "selected":""); ?>>Divorced</option>
                                                 </select>
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  class="form-control date" name="doj" value="<?php echo e($agent->doj); ?>">
                                             </div>
                                     ...
                                     <div class="form-row">
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  class="form-control" name="occupation" value="<?php echo e($agent->occupation); ?>" placeholder="Occupation">
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text" name="qualification"  value="<?php echo e($agent->qualification); ?>" class="form-control" placeholder="Qualification">
                                             </div>
                                      ...
                                      <div class="form-row">
                                       <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                          <div class="form-label-group">
                                             ...
                                             <input type="text" name="designation"  value="<?php echo e($agent->designation); ?>" class="form-control" placeholder="Designation / Department">
                                         </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                       ...
                                       <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                           <div class="form-label-group">
                                            ...
                                            <option value="<?php echo e($doc->id); ?>" <?php echo e($agent->document_id == $doc->id ? "selected":""); ?>><?php echo e($doc->name); ?></option>
...
if (isset($messageCache)) { $message = $messageCache; }
                                       ...
                                       <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                           <div class="form-label-group">
                                               ...
                                               <input type="text" name="document_number"  value="<?php echo e($agent->document_number); ?>" class="form-control" placeholder="Document Number">
                                           </div>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <select  name="state" class="form-control nominee_state">
                                                  ...
                                                  <option  value="<?php echo e($state->id); ?>" <?php echo e($agent->state == $state->id ? "selected":""); ?>><?php echo e($state->name); ?></option>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <select name="district" class="form-control nominee_district">
                                                  ...
                                                  <option  value="<?php echo e($city->id); ?>" <?php echo e($agent->district == $city->id ? "selected":""); ?>><?php echo e($city->name); ?></option>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <select id="ptalukname" name="taluk" class="form-control nominee_taluk">
                                                  ...
                                                  <option  value="<?php echo e($taluk->id); ?>" <?php echo e($agent->taluk == $taluk->id ? "selected":""); ?>><?php echo e($taluk->name); ?></option>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                 </select>
                                             </div>
                                         ...
                                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                             <div class="form-label-group">
                                                 ...
                                                 <select  name="village" class="form-control nominee_village">
                                                  ...
                                                  <option  value="<?php echo e($village->id); ?>" <?php echo e($agent->village == $village->id ? "selected":""); ?> ><?php echo e($village->name); ?></option>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                 </select>
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                          ...
                                          <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <textarea  class="form-control" name="address" rows="2" ><?php echo e($agent->address); ?></textarea>
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  class="form-control" name="pincode" value="<?php echo e($agent->pincode); ?>" placeholder="Pin code">
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="mobile_no" value="<?php echo e($agent->mobile_no); ?>" class="form-control" placeholder="Mobile No">
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="phone_no" value="<?php echo e($agent->phone_no); ?>" class="form-control" placeholder="Phone No">
                                             </div>
...
if (isset($messageCache)) { $message = $messageCache; }
                                         ...
                                         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                             <div class="form-label-group">
                                                 ...
                                                 <input type="text"  name="mail_id" class="form-control" value="<?php echo e($agent->mail_id); ?>" placeholder="Mail ID">
                                             </div>
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                           <div class="form-row">
                               ...
                               <div class="col-12 col-sm-12 col-md-5 col-lg-4 col-xl-4 uploadbtn">
                                   <input type="hidden"  class="form-control profile" name="image" value="<?php echo e($agent->image); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\finance\finance\resources\views/agent/edit.blade.php ENDPATH**/ ?>