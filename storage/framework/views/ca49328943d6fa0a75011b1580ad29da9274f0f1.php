                	...
                	<div class="widget-bg"> 
                      ...
                      <div class="card-header">
                      	<div class="inner-header">
                        	<div class="fl_in_h"><h5>Employee</h5></div>
                            <div class="fr_in_h">
                                <button class="btn btn-link btn-sm btn-global btn-dark btn-fl-r" id="ExportReporttoExcel" >
                                    <i class="fa fa-file-excel-o" aria-hidden="true"></i>
                                    <span>Export</span></button>
                            <a class="btn btn-link btn-sm btn-global btn-blue btn-fl-r"  href="<?php echo e(route('employee.create')); ?>">
...
$(document).ready(function() {
  ...
  var table= $('.subscriber').DataTable({
        ...
        "ajax": "<?php echo e(route('employee.getdata')); ?>",
        ...
        "columns":[
          { "data": "unique_id" },
            ...
            { "data": "id",render: function ( data, type, row ) {
                if ( type === 'display' ) {
                  var url = '<?php echo e(route("employee.edit", [":id"])); ?>';
     ...
     $(document).on("click",".show",function(e) {
      e.preventDefault();
       var id=$(this).attr("data-id");
        var show_url="<?php echo e(route('employee.show', ['agent' =>":id"])); ?>";
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\finance\finance\resources\views/employee/index.blade.php ENDPATH**/ ?>