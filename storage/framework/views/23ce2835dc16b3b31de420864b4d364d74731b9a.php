<?php $__env->startSection('title', 'State'); ?>
...
<div class="col-lg-9 col-md-8 col-sm-8 col-2">
            	...
            	<div class="breadcrumbbar">
                	<ul>
                        ...
                        <a href="<?php echo e(url('state')); ?>"><span>State</span><i class="fas fa-arrow-left fa-fw"></i></a>
                        </li>
...
<?php $__env->startSection('content'); ?>
          ...
          <div class="card-header">
          	<div class="inner-header">
            	<div class="fl_in_h"><h5>State</h5></div>
                <div class="fr_in_h">
                    <button class="btn btn-link btn-sm btn-global btn-dark btn-fl-r" id="ExportReporttoExcel" >
                        <i class="fa fa-file-excel-o" aria-hidden="true"></i>
                        <span>Export</span></button>
                <a class="btn btn-link btn-sm btn-global btn-blue btn-fl-r"  href="<?php echo e(route('state.create')); ?>">
...
$(document).ready(function() {
  ...
  var editIcon = function ( data, type, full, meta ) {
   ...
   var table=  $('.subscriber').DataTable({
        ...
        "ajax": "<?php echo e(route('state.getdata')); ?>",
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\New folder\resources\views/state/index.blade.php ENDPATH**/ ?>