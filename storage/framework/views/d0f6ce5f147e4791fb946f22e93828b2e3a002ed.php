...
<div class="col-lg-9 col-md-8 col-sm-8 col-2">
            	...
            	<div class="breadcrumbbar">
                	<ul>
                        ...
                        <a href="<?php echo e(url('branch')); ?>"><span>Branch</span><i class="fas fa-arrow-left fa-fw"></i></a>
                        </li>
...
<?php $__env->startSection('content'); ?>
          ...
          <div class="card-header">
          	<div class="inner-header">
                ...
                <a class="btn btn-link btn-sm btn-global btn-blue btn-fl-r"  href="<?php echo e(route('branch.create')); ?>">
...
$(document).ready(function() {
  ...
  var editIcon = function ( data, type, full, meta ) {
    ...
    var table= $('.branch').DataTable({
        ...
        "ajax": "<?php echo e(route('branch.getdata')); ?>",
        ...
        "columns":[
          ...
          { "data": "unique_id" },
            ...
            { "data": "id",render: function ( data, type, row ) {
                if ( type === 'display' ) {
                  var url = '<?php echo e(route("branch.edit", [":id"])); ?>';
                  var show_url="<?php echo e(route('branch.show', ['branch' =>":id"])); ?>";
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\finance\finance\resources\views/branch/index.blade.php ENDPATH**/ ?>